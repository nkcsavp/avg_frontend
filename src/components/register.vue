<template>
  <div>
    ...
    <el-form ref="registerForm" :hide-required-asterisk="true" :label-position="'left'" :model="registerForm" :rules="rules"
...
<script>
import {Transaction,Send} from "@icon-park/vue-next";
